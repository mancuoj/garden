...
class HiderSettingTab extends obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        "Hides the Obsidian menu. Warning: to open Settings you will need use the hotkey (default is CMD + ,)",
      )
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideRibbon).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideTabs).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideStatus).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideVault).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideScroll).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideSidebarButtons).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideTooltips).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideFileNavButtons).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideInstructions).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideSearchSuggestions).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hideSearchCounts).onChange((value) => {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.hidePropertiesReading).onChange((value) => {
