...
var NoteRefactorSettingsTab = /** @class */ (function (_super) {
  ...
  NoteRefactorSettingsTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addDropdown(function (dropDown) {
        return dropDown
          ...
          .setValue(
            Location[_this.plugin.settings.newFileLocation] || Location.VaultFolder.toString(),
          )
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        "When content has been extracted/split into a new note, include a transclusion of the new note",
      )
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.transcludeByDefault)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        this.tempalteDescriptionContent(
          "The template used to generate the content for the refactored note.",
        ),
      )
      .addTextArea(function (text) {
        text
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.excludeFirstLineInNote)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.includeFirstLineAsNoteHeading)
          .onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc(
        "When content has been extracted/split into a new note, normalize the levels of the headings",
      )
      .addToggle(function (toggle) {
        return toggle
          .setValue(_this.plugin.settings.normalizeHeaderLevels)
          .onChange(function (value) {
  ...
  NoteRefactorSettingsTab.prototype.tempalteDescriptionContent = function (introText) {
    ...
    descEl.appendChild(document.createElement("br"))
    descEl.appendText(
      "{{date}} {{title}} {{link}} {{new_note_title}} {{new_note_link}} {{new_note_content}}",
    )
    return descEl
  }
  ...
  NoteRefactorSettingsTab.prototype.updateFileNamePrefixUPop = function () {
    this.filePrefixUPop.innerText = this.momentDateRegex.replace(
...
var NRDoc = /** @class */ (function () {
  ...
  NRDoc.prototype.replaceContent = function (
    fileName,
    filePath,
    doc,
    currentNote,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.templatedContent(this.content, currentFile, filePath, fileName),
            ]
          case 2:
...
var NoteRefactor = /** @class */ (function (_super) {
                ...
                return _this.editModeGuard(function () {
                  return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          return [4 /*yield*/, this.extractSelectionFirstLine("replace-selection")]
                        case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.createAutogeneratedNote(selectedContent, mdView, doc, mode, true),
            ]
          case 1:
  ...
  NoteRefactor.prototype.createAutogeneratedNote = function (
    selectedContent,
    mdView,
    doc,
    mode,
